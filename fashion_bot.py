...
# Модули проекта
from config import *
from news_parser import get_fashion_news, format_news_message
...
def _generate_image_direct(prompt, size, base_face_url=None):
    """Генерация изображения через API (без лишних пробелов в URL!)"""
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    welcome_text = (
        ...
        "🗞 **Новости моды:** Парсинг 8 мировых источников с умным кэшированием!\n\n"
